...
- **`.env.local` setup**: Copy `.env.example` to `.env.local` before starting the dev server. The example file contains working Supabase project credentials for the shared dev instance.
