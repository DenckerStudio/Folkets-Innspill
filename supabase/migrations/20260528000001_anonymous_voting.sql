...
BEGIN
  ...
  INSERT INTO public.user_profiles (user_id, identity_verified)
...
GRANT EXECUTE ON FUNCTION public.cast_vote TO service_role;
GRANT EXECUTE ON FUNCTION public.get_issue_vote_totals TO service_role, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_vote_totals_batch TO service_role;
GRANT EXECUTE ON FUNCTION public.get_user_vote_on_issue TO service_role;
GRANT EXECUTE ON FUNCTION public.get_user_vote_history TO service_role;
